      ...
      <article className="flex items-start justify-between gap-4 px-4 py-4 transition hover:bg-[color:var(--surface-elevated)]/70">
        <div className="min-w-0 flex-1">
          <div className="mb-1 flex items-center gap-2">
            ...
            {badge ? (
              <span className="rounded-sm border border-amber-400/50 bg-amber-500/10 px-1.5 py-0.5 text-[11px] text-amber-700">
                {badge}
              </span>
            ) : null}
          </div>
        ...
        <div className="shrink-0 text-right">
          <p className="mb-2 text-xs text-slate-500">♡ {item.likeCount} · 💬 {item.commentCount}</p>
