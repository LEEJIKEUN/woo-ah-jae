  ...
  return (
    <section className="space-y-4">
      <label className="block space-y-1">
        <span className="text-sm text-slate-600">상단 고정 공지</span>
        <textarea value={pinnedNotice} onChange={(e) => setPinnedNotice(e.target.value)} rows={5} className={INPUT_CLASS} />
      </label>
      <label className="block space-y-1">
        <span className="text-sm text-slate-600">Google Drive URL</span>
        <input
      ...
      <label className="block space-y-1">
        <span className="text-sm text-slate-600">Google Sheet URL</span>
      ...
      <label className="block space-y-1">
        <span className="text-sm text-slate-600">Google Docs URL</span>
      ...
      <label className="block space-y-1">
        <span className="text-sm text-slate-600">최종 보고서(PDF)</span>
