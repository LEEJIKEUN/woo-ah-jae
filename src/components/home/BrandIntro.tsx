  ...
  return (
    <section className="relative flex min-h-[320px] items-start overflow-hidden rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface)]/90 px-6 py-6 backdrop-blur-sm md:h-[58vh] md:max-h-[560px] md:px-10 md:py-8">
      ...
      <div className="relative max-w-4xl space-y-5">
        <h1 className="text-3xl font-extrabold leading-tight tracking-tight text-[color:var(--primary)] md:text-5xl md:leading-tight">
          함께 연구하고 발표하는 프로젝트 커뮤니티
        </h1>
        <p className="w-max max-w-none whitespace-nowrap text-sm leading-7 text-[color:var(--muted)] md:text-base">
          전 세계 한국학교와 국제학교 학생들이 팀을 만들어 공부와 탐구를 지속할 수 있도록, 인증 기반의 안전한 협업공간을 제공합니다.
        </p>
