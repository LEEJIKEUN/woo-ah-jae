  ...
  return (
    <section className="relative overflow-hidden rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface)] p-7 md:p-12">
      ...
      <div className="relative max-w-3xl space-y-5">
        ...
        <p className="max-w-2xl text-base leading-8 text-slate-600">{item.summary}</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/category"
            className="rounded-md border border-slate-200 px-4 py-2.5 text-sm font-semibold text-slate-800 transition hover:bg-slate-200/50"
          >
            카테고리 이동
          </Link>
        </div>
